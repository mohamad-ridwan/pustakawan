...
// body pdf
let docDefinition = {
    footer: function (currentPage, pageCount) { return {text: currentPage.toString() + ' of ' + pageCount, margin: [20, 20, 20, 20], alignment: 'right', fontSize: 9} },
    header: function (currentPage, pageCount, pageSize) {
        // you can apply any logic and return any valid pdfmake element

        return [
            { text: `Transkrip Data Pustakawan dari (${paramsURL?.get('dataDaerah')})`, alignment: (currentPage % 2) ? 'left' : 'right', margin: [20, 20, 20, 20] },
